...
@section('image')     
    <img class="hero-img" src="/images/home-photo.jpg" alt="Photo of jewelry"> 
@endsection
    ...
    @section('content')
        ...
        <div class="flex" id="home-flex">
            <div id="flex-left">
                ...
                <p>If you would like to be notified of the arrival of our handmade jewelry line, <a class="link-hover" href="/newsletter"><em>sign up for our newsletter. </em></a>You will also receive lots of useful information about our products and related topics.</p>
            </div>
